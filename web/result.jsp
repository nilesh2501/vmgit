...
<!-- css files-->
  ...
  <%!
           ...
           public static double ans, wweight2,ddistance;           
...
Maximum compensation for Lost or Damage or Shortage, Rs.1000 or Invoice value, which ever is lower.</pre>
    ...
    <div id="result_div5_6" class="fluid">
        ...
        <input type="submit" class="btn btn-success btn-lg btn-block" name="Book Now" value="Book Now">
        </form>
    </div>
    <p>&nbsp;</p>
  </div>
